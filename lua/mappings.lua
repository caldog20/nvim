...
--   plugin = true,
  n = {
    ["<leader>gsj"] = {
      ...
      "Gopher Add json struct tags"
    },
    ["<leader>gsy"] = {
      "<cmd> GoTagAdd yaml <CR>",
      "Gopher Add yaml struct tags"
    }
  }
}
...
M.caleb = {
  ...
  n = {
    ["<leader>s"] = { ":%s/<C-r><C-w>//g<Left><Left>", "Caleb Search and replace" },
...
M.harpoon = {
  ...
  n = {
    ...
    ["<leader>'"] = {
      ...
      "Harpoon Toggle Harpoon quick menu"
    },
    ["<leader>1"] = {
      function()
        local harpoon = require "harpoon"
...
M.git = {
  n = {
    ["<leader>gp"] = { "<cmd> Git push<CR>", "Git Push git changes to remote" },
    ["<leader>ga"] = { "<cmd> Gwrite<CR>", "Git Add current file to stage list" },
    ["<leader>gg"] = { "<cmd> Git<CR>", "Git Open vim-fugitive buffer" },
    ["<leader>gc"] = { "<cmd> Git commit<CR>", "Git Commit currently staged changes" },
  }
}
